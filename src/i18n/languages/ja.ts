...
export const ja: Translation = {
	...
	// 小説棚
	[Key.novels]: "小説棚",
	[Key.novelsDescription]: "ここで小説を読んだり管理したりできます",
	[Key.novelsNoNovels]: "小説がありません",
	[Key.novelsAuthor]: "著者",
	[Key.novelsStatusOngoing]: "連載中",
	[Key.novelsStatusCompleted]: "完結",
	[Key.novelsChapters]: "章",
	[Key.novelsChapterCount]: "全 {count} 章",
	[Key.novelsBackToNovel]: "小説詳細に戻る",
	[Key.novelsTableOfContents]: "目次",
	[Key.novelsPrevChapter]: "前の章",
	[Key.novelsNextChapter]: "次の章",

	// 音楽ライブラリ
	[Key.musicLibrary]: "音楽ライブラリ",
	[Key.musicLibraryDescription]: "お気に入りの音楽を収集して再生",
	[Key.musicLibraryNoItems]: "音楽がありません",
	[Key.musicLibraryPlay]: "再生",
	[Key.musicLibraryArtist]: "アーティスト",
	[Key.musicLibraryAlbum]: "アルバム",

	// アニメコレクション
	[Key.anime]: "アニメ",
	[Key.animeDescription]: "アニメの視聴記録",
	[Key.animeNoItems]: "アニメがありません",
	[Key.animeRating]: "評価",
	[Key.animeStatusWatching]: "視聴中",
	[Key.animeStatusCompleted]: "視聴済み",
	[Key.animeStatusOnHold]: "一時停止",
	[Key.animeStatusDropped]: "中断",
	[Key.animeStatusPlanToWatch]: "観たい",
	[Key.animeEpisodes]: "話数",
	[Key.animeFilterAll]: "すべて",

	// 管理パネル
	[Key.admin]: "管理パネル",
	[Key.adminDescription]: "アニメ、音楽ライブラリ、小説を管理",
	[Key.adminAnime]: "アニメ",
	[Key.adminMusic]: "音楽",
	[Key.adminNovels]: "小説",
	[Key.adminAdd]: "追加",
	...
	[Key.adminExport]: "エクスポート",
	[Key.adminImport]: "インポート",
	[Key.adminImportReplace]: "置換インポート",
	[Key.adminImportMerge]: "マージインポート",
	[Key.adminNoItems]: "データがありません",
	[Key.adminDeleteConfirm]: "削除してもよろしいですか？",
	[Key.adminExportSuccess]: "データをエクスポートしました",
	[Key.adminImportSuccess]: "データのインポートに成功しました",
	[Key.adminImportError]: "データのインポートに失敗しました",
};
