...
export const zh_TW: Translation = {
	...
	// 小說書架
	[Key.novels]: "小說書架",
	[Key.novelsDescription]: "在這裡閱讀和管理你的小說",
	[Key.novelsNoNovels]: "暫無小說",
	[Key.novelsAuthor]: "作者",
	[Key.novelsStatusOngoing]: "連載中",
	[Key.novelsStatusCompleted]: "已完結",
	[Key.novelsChapters]: "章節",
	[Key.novelsChapterCount]: "共 {count} 章",
	[Key.novelsBackToNovel]: "返回小說詳情",
	[Key.novelsTableOfContents]: "目錄",
	[Key.novelsPrevChapter]: "上一章",
	[Key.novelsNextChapter]: "下一章",

	// 音樂庫
	[Key.musicLibrary]: "音樂庫",
	[Key.musicLibraryDescription]: "收藏和播放你喜歡的音樂",
	[Key.musicLibraryNoItems]: "暫無音樂",
	[Key.musicLibraryPlay]: "播放",
	[Key.musicLibraryArtist]: "藝術家",
	[Key.musicLibraryAlbum]: "專輯",

	// 動畫收藏
	[Key.anime]: "動畫收藏",
	[Key.animeDescription]: "記錄你的動畫觀看之旅",
	[Key.animeNoItems]: "暫無動畫",
	[Key.animeRating]: "評分",
	[Key.animeStatusWatching]: "在看",
	[Key.animeStatusCompleted]: "看完",
	[Key.animeStatusOnHold]: "擱置",
	[Key.animeStatusDropped]: "拋棄",
	[Key.animeStatusPlanToWatch]: "想看",
	[Key.animeEpisodes]: "集數",
	[Key.animeFilterAll]: "全部",

	// 後台管理
	[Key.admin]: "後台管理",
	[Key.adminDescription]: "管理動畫收藏、音樂庫和小說內容",
	[Key.adminAnime]: "動畫收藏",
	[Key.adminMusic]: "音樂庫",
	[Key.adminNovels]: "小說",
	[Key.adminAdd]: "新增",
	...
	[Key.adminSave]: "儲存",
	[Key.adminCancel]: "取消",
	[Key.adminExport]: "匯出資料",
	[Key.adminImport]: "匯入資料",
	[Key.adminImportReplace]: "替換匯入",
	[Key.adminImportMerge]: "合併匯入",
	[Key.adminNoItems]: "暫無資料",
	[Key.adminDeleteConfirm]: "確定要刪除嗎？",
	[Key.adminExportSuccess]: "資料已匯出",
	[Key.adminImportSuccess]: "資料匯入成功",
	[Key.adminImportError]: "資料匯入失敗",
};
