...
export const en: Translation = {
	...
	// Novels
	[Key.novels]: "Novel Bookshelf",
	[Key.novelsDescription]: "Read and manage your novels here",
	[Key.novelsNoNovels]: "No novels yet",
	[Key.novelsAuthor]: "Author",
	[Key.novelsStatusOngoing]: "Ongoing",
	[Key.novelsStatusCompleted]: "Completed",
	[Key.novelsChapters]: "Chapters",
	[Key.novelsChapterCount]: "{count} chapters",
	[Key.novelsBackToNovel]: "Back to novel",
	[Key.novelsTableOfContents]: "Table of Contents",
	[Key.novelsPrevChapter]: "Previous Chapter",
	[Key.novelsNextChapter]: "Next Chapter",

	// Music Library
	[Key.musicLibrary]: "Music Library",
	[Key.musicLibraryDescription]: "Collect and play your favorite music",
	[Key.musicLibraryNoItems]: "No music yet",
	[Key.musicLibraryPlay]: "Play",
	[Key.musicLibraryArtist]: "Artist",
	[Key.musicLibraryAlbum]: "Album",

	// Anime Collection
	[Key.anime]: "Anime",
	[Key.animeDescription]: "Track your anime journey",
	[Key.animeNoItems]: "No anime yet",
	[Key.animeRating]: "Rating",
	...
	[Key.animeStatusPlanToWatch]: "Plan to Watch",
	[Key.animeEpisodes]: "Episodes",
	[Key.animeFilterAll]: "All",

	// Admin
	[Key.admin]: "Admin Panel",
	[Key.adminDescription]: "Manage anime, music library, and novels",
	[Key.adminAnime]: "Anime",
	[Key.adminMusic]: "Music",
	[Key.adminNovels]: "Novels",
	[Key.adminAdd]: "Add",
	[Key.adminEdit]: "Edit",
	[Key.adminDelete]: "Delete",
	[Key.adminSave]: "Save",
	[Key.adminCancel]: "Cancel",
	[Key.adminExport]: "Export",
	[Key.adminImport]: "Import",
	[Key.adminImportReplace]: "Replace Import",
	[Key.adminImportMerge]: "Merge Import",
	[Key.adminNoItems]: "No items yet",
	[Key.adminDeleteConfirm]: "Are you sure you want to delete?",
	[Key.adminExportSuccess]: "Data exported",
	[Key.adminImportSuccess]: "Data imported successfully",
	[Key.adminImportError]: "Data import failed",
};
