...
export const zh_CN: Translation = {
	...
	// 小说书架
	[Key.novels]: "小说书架",
	[Key.novelsDescription]: "在这里阅读和管理你的小说",
	[Key.novelsNoNovels]: "暂无小说",
	[Key.novelsAuthor]: "作者",
	[Key.novelsStatusOngoing]: "连载中",
	[Key.novelsStatusCompleted]: "已完结",
	[Key.novelsChapters]: "章节",
	[Key.novelsChapterCount]: "共 {count} 章",
	[Key.novelsBackToNovel]: "返回小说详情",
	[Key.novelsTableOfContents]: "目录",
	[Key.novelsPrevChapter]: "上一章",
	[Key.novelsNextChapter]: "下一章",

	// 音乐库
	[Key.musicLibrary]: "音乐库",
	[Key.musicLibraryDescription]: "收藏和播放你喜欢的音乐",
	[Key.musicLibraryNoItems]: "暂无音乐",
	[Key.musicLibraryPlay]: "播放",
	[Key.musicLibraryArtist]: "艺术家",
	[Key.musicLibraryAlbum]: "专辑",

	// 动画收藏
	[Key.anime]: "动画收藏",
	[Key.animeDescription]: "记录你的动画观看之旅",
	[Key.animeNoItems]: "暂无动画",
	[Key.animeRating]: "评分",
	...
	// 后台管理
	[Key.admin]: "后台管理",
	[Key.adminDescription]: "管理动画收藏、音乐库和小说内容",
	[Key.adminAnime]: "动画收藏",
	[Key.adminMusic]: "音乐库",
	[Key.adminNovels]: "小说",
	[Key.adminAdd]: "添加",
	...
	[Key.adminSave]: "保存",
	[Key.adminCancel]: "取消",
	[Key.adminExport]: "导出数据",
	[Key.adminImport]: "导入数据",
	[Key.adminImportReplace]: "替换导入",
	[Key.adminImportMerge]: "合并导入",
	[Key.adminNoItems]: "暂无数据",
	[Key.adminDeleteConfirm]: "确定要删除吗？",
	[Key.adminExportSuccess]: "数据已导出",
	[Key.adminImportSuccess]: "数据导入成功",
	[Key.adminImportError]: "数据导入失败",
};
