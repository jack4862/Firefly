...
export const ru: Translation = {
	...
	// Полка новелл
	[Key.novels]: "Полка новелл",
	[Key.novelsDescription]: "Читайте и управляйте своими новеллами здесь",
	[Key.novelsNoNovels]: "Нет новелл",
	[Key.novelsAuthor]: "Автор",
	[Key.novelsStatusOngoing]: "Продолжается",
	[Key.novelsStatusCompleted]: "Завершено",
	[Key.novelsChapters]: "Главы",
	[Key.novelsChapterCount]: "{count} глав",
	[Key.novelsBackToNovel]: "Вернуться к новелле",
	[Key.novelsTableOfContents]: "Содержание",
	[Key.novelsPrevChapter]: "Предыдущая глава",
	[Key.novelsNextChapter]: "Следующая глава",

	// Музыкальная библиотека
	[Key.musicLibrary]: "Музыкальная библиотека",
	[Key.musicLibraryDescription]: "Собирайте и воспроизводите любимую музыку",
	[Key.musicLibraryNoItems]: "Нет музыки",
	[Key.musicLibraryPlay]: "Воспроизвести",
	[Key.musicLibraryArtist]: "Исполнитель",
	[Key.musicLibraryAlbum]: "Альбом",

	// Коллекция аниме
	[Key.anime]: "Аниме",
	[Key.animeDescription]: "Записи просмотра аниме",
	[Key.animeNoItems]: "Нет аниме",
	[Key.animeRating]: "Оценка",
	...
	[Key.animeStatusPlanToWatch]: "Планирую",
	[Key.animeEpisodes]: "Эпизоды",
	[Key.animeFilterAll]: "Все",

	// Панель администратора
	[Key.admin]: "Панель администратора",
	[Key.adminDescription]: "Управление аниме, музыкальной библиотекой и новеллами",
	[Key.adminAnime]: "Аниме",
	[Key.adminMusic]: "Музыка",
	[Key.adminNovels]: "Новеллы",
	[Key.adminAdd]: "Добавить",
	[Key.adminEdit]: "Редактировать",
	[Key.adminDelete]: "Удалить",
	[Key.adminSave]: "Сохранить",
	[Key.adminCancel]: "Отмена",
	[Key.adminExport]: "Экспорт",
	[Key.adminImport]: "Импорт",
	[Key.adminImportReplace]: "Заменить импорт",
	[Key.adminImportMerge]: "Объединить импорт",
	[Key.adminNoItems]: "Нет данных",
	[Key.adminDeleteConfirm]: "Вы уверены, что хотите удалить?",
	[Key.adminExportSuccess]: "Данные экспортированы",
	[Key.adminImportSuccess]: "Данные успешно импортированы",
	[Key.adminImportError]: "Ошибка импорта данных",
};
